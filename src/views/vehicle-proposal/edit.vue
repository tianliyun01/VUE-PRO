      ...
      <el-tabs v-model="activeName" class="customcard">
        <el-tab-pane label="对比列表" name="first">
          <el-table :data="compareList" style="width: 100%">
            ...
            <el-table-column prop="estimateAvgIndemnity" align="center" label="目标出险率" min-width="180" show-overflow-tooltip>
              <template slot-scope="scope">
                <el-input v-model="scope.row.accidentRate" :disabled="true" />
              </template>
            </el-table-column>
            <el-table-column prop="estimateAvgIndemnity" align="center" label="目标赔付费用" min-width="180" show-overflow-tooltip>
              <template slot-scope="scope">
