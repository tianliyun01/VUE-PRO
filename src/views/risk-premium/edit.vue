      ...
      <el-tabs v-model="activeName" class="customcard">
        <el-tab-pane label="对比列表" name="first">
          <el-table :data="compareList" style="width: 100%">
            ...
            <el-table-column prop="sourceTypeName" label="结果类型" min-width="150" show-overflow-tooltip align="center" />
            ...
            <el-table-column prop="brandName" label="品牌" min-width="150" show-overflow-tooltip align="center" />
            ...
            <el-table-column prop="undrewRiskLevel" label="承保风险等级" min-width="150" show-overflow-tooltip align="center" />
            ...
            <el-table-column prop="estimateRiskPremium" label="CIRI风险保费" min-width="150" show-overflow-tooltip align="center" />
            ...
            <el-table-column prop="payRiskLevel" label="赔付风险等级" min-width="150" show-overflow-tooltip align="center" />
            ...
            <el-table-column prop="accidentLevel" label="出险风险等级" min-width="150" show-overflow-tooltip align="center" />
            ...
            <el-table-column prop="accidentRate" label="出险率" min-width="150" show-overflow-tooltip align="center" />
            ...
            <el-table-column prop="partFee" label="常用配件价格" min-width="150" show-overflow-tooltip align="center" />
    ...
    <div class="query mgt-14" style="position: relative;">
      ...
      <div>
        <el-table :data="pageInfo" style="width: 100%" @selection-change="handleSelectionChange">>
          ...
          <el-table-column prop="dataSourceName" label="结果来源" min-width="120" show-overflow-tooltip align="center" />
          ...
          <el-table-column prop="estimateRiskPremium" label="CIRI风险保费" min-width="120" show-overflow-tooltip align="center" />
          ...
          <el-table-column prop="accidentRate" label="出险率" min-width="120" show-overflow-tooltip align="center" />
        ...
        if (res.state === '0000') {
          if (res.riskPremiumDtoList && res.riskPremiumDtoList.length > 0) {
            for (let i = 0; i < res.riskPremiumDtoList.length; i++) {
              ...
              res.riskPremiumDtoList[i].sourceType = 'B'
