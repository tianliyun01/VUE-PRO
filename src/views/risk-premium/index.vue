  ...
  <div class="app-container">
    <div class="Notice">
      <el-tabs v-model="activeName" class="customcard">
        <el-tab-pane label="承保风险查询" name="first">
    ...
    <div class="query mgt-14">
      ...
      <div>
        <el-table :data="systemListResult" style="width: 100%">
          ...
          <el-table-column prop="activeType" label="承保风险等级" width="120" />
          <el-table-column prop="activeType" label="风险保费" width="320" show-overflow-tooltip />
          <el-table-column prop="activeType" label="赔付风险等级" width="320" show-overflow-tooltip />
          <el-table-column prop="activeType" label="案均赔款" width="320" show-overflow-tooltip />
          <el-table-column prop="activeType" label="18件配件价格" width="320" show-overflow-tooltip />
          <el-table-column prop="activeType" label="出险风险等级" width="320" show-overflow-tooltip />
          <el-table-column prop="activeType" label="出险率" width="320" show-overflow-tooltip />
