    ...
    <div class="query mgt-14">
      ...
      <div>
        <el-table :data="pageInfo" style="width: 100%">
          ...
          <el-table-column prop="carSystemEncode" label="车系代码" min-width="120" show-overflow-tooltip align="center" />
          ...
          <el-table-column prop="accidentRate" label="CIRI出险率" min-width="120" show-overflow-tooltip align="center" />
